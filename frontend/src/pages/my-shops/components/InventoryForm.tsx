                ...
                <div className="flex flex-col w-full bg-bg-secondary flex-1">
                    ...
                    <div className="w-full bg-bg-secondary h-full flex-1 flex">
                        {activeTab === 'manual' ? (
                            ...
                            <div className="flex flex-col flex-1 w-full bg-[var(--color-bg-secondary)] overflow-hidden min-h-0 md:min-h-[521px]">
                                        ...
                                        <div className="flex justify-between items-center mt-4">
                                            ...
                                            <div className="flex gap-3">
                                                <button
                                                    type="submit"
                                                    disabled={isLoading}
                                                    className="px-6 py-2 bg-brand-green hover:bg-brand-green-hover text-text-white cursor-pointer rounded-lg disabled:bg-zinc-400 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
                                                >
                                                    {isLoading ? (
                                                        <>
                                                            <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
