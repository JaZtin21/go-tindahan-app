    ...
    return (
        ...
        w-full here = the wrapper's width = the card's true visible border-box width, always. */}
            ...
            <div className="grid grid-cols-2  md:grid-cols-4 lg:grid-cols-5 gap-6">
                ...
                >
                    <div className="relative w-full aspect-video bg-brand-gold/10 group-hover:bg-bg-primary transition-all duration-300 rounded-xl mb-4 shrink-0 flex items-center justify-center overflow-hidden">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="450.000000pt" height="450.000000pt" viewBox="-50 -30 450.000000 450.000000" preserveAspectRatio="xMidYMid meet">
                            <g transform="translate(0.000000,350.000000) scale(0.050000,-0.050000)" fill="var(--color-brand-gold)" opacity="0.4" stroke="none">
                                <path d="M3040 6080 c-37 -37 -40 -67 -40 -437 l0 -397 -252 -2 c-315 -3 -408 -67 -293 -200 81 -94 1010 -844 1045 -844 33 0 703 537 985 790 193 173 123 252 -229 257 l-246 3 -10 402 c-7 299 -17 410 -37 435 -46 55 -867 49 -923 -7z m716 -610 c7 -470 1 -455 206 -470 l140 -10 -289 -240 c-159 -132 -299 -240 -312 -240 -12 0 -153 108 -312 240 l-290 240 137 10 c211 15 204 -1 204 459 0 217 6 401 14 408 8 8 122 12 255 9 l241 -6 6 -400z" /> <path d="M940 4240 c-102 -102 -70 -138 335 -369 l305 -174 0 -1364 c0 -1202 4 -1369 31 -1409 l31 -44 1858 0 1858 0 31 44 c27 40 31 207 31 1408 l0 1364 315 180 c339 194 390 242 350 332 -35 76 -116 88 -214 31 -45 -26 -198 -112 -341 -193 l-260 -146 -1772 0 -1773 0 -331 190 c-351 201 -390 214 -454 150z m1840 -1179 c0 -499 4 -582 31 -610 49 -48 1318 -47 1372 2 34 31 37 77 37 610 l0 577 480 0 480 0 0 -850 0 -850 -1680 0 -1680 0 0 850 0 850 480 0 480 0 0 -579z m1195 94 l-5 -485 -475 -5 -475 -6 0 491 0 490 480 0 481 0 -6 -485z m1201 -1750 l-6 -275 -1670 0 -1670 0 -6 275 -5 275 1681 0 1681 0 -5 -275z" />
                            </g> </svg>
                    </div>
                    <div className="flex-1">
